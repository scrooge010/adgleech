...
<body>
  <!--© Designed and coded by @bipuldey19-Telegram-->
    <header>
      ...
      <div class="social">
        <a href="https://github.com/scrooge010/leech"><i class="fab fa-github"></i></a>
...
async def homepage(request):
    ...
    return web.Response(text="<h1>See slam-mirrorbot <a href='https://github.com/scrooge010/leech'>@GitHub</a> By <a href='https://github.com/scrooge010'>SlamDevs</a></h1>", content_type="text/html")
